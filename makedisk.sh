...
./spindle-2.3/spindle/spin -v -e f00 script
...
#./cc1541 -w demo.prg -w d_fox.bin -w d_broke.bin -w d_dither1.bin -w d_dither2.bin -w d_dither3.bin -w d_bune.bin -w bolgreets.bin -w terminal.bit -w terminal.chr -w terminal.d80 test.d64 && /Applications/Vice/x64.app/Contents/MacOS/x64 test.d64
